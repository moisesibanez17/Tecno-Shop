...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $id_computadora = $_POST['id_computadora'] ?? 0;
    $cantidad_restar = $_POST['cantidad_computadora'] ?? 1;

    // Simulación de autenticación exitosa
    $autenticado = true;
    $id_cliente = rand(1, 100);
    $id_orden = rand(1000, 9999);
    $stock_actual = 10; // Stock simulado
        ...
        <body>
            <div class="admin-container" style="text-align: center; padding: 4rem 2rem;">
                <div class="admin-form-container" style="max-width: 600px; margin: 0 auto;">
                    ...
                    <h1 style="color: #10b981; margin-bottom: 1rem;">¡Orden Completada!</h1>
                    <div style="background: rgba(16, 185, 129, 0.1); border: 1px solid #10b981; border-radius: 12px; padding: 1.5rem; margin: 2rem 0; text-align: left;">
                        ...
                        <p style="color: #94a3b8; margin: 0.5rem 0;"><strong>ID Computadora:</strong> #<?php echo $id_computadora; ?></p>
                    ...
                    <button class="btn-success" onclick="location.href='../client/catalogo_computadoras.php'">
                        Volver al Catálogo
                    </button>
                </div>
            </div>
            ...
            <div class="admin-container" style="text-align: center; padding: 4rem 2rem;">
                <div class="admin-form-container" style="max-width: 600px; margin: 0 auto;">
                    ...
                    <p style="color: #94a3b8; font-size: 1.1rem; margin-bottom: 2rem;">
                        No hay suficiente stock disponible<br>
    ...
    <body>
        <div class="admin-container" style="text-align: center; padding: 4rem 2rem;">
            <div class="admin-form-container" style="max-width: 600px; margin: 0 auto;">
                ...
                <button class="btn-secondary" onclick="location.href='../client/catalogo_computadoras.php'">
                    Ir al Catálogo de Computadoras
                </button>
            </div>
        </div>
    </body>
